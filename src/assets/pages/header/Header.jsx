...
const Header = () => {
    ...
    return (
        <div className="navbar bg-blue-700 text-white py-4 px-16 shadow top-0 font-semibold relative z-10">
            <div className="navbar-start">
                <div className="dropdown text-black">
                    <label tabIndex={0} className="btn btn-ghost lg:hidden text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </label>
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 text-[16px]">
            ...
            <div className="navbar-end gap-5">
                    ...
                    {/* <NavLink className='btn bg-white shadow-md shadow-white hover:btn-primary font-semibold rounded-lg'>Logout
                    </NavLink> : */}
                    <NavLink className='btn bg-white shadow-md shadow-white hover:btn-primary hover:text-white font-semibold rounded-lg'>Login
                    </NavLink>
